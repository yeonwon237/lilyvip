      ...
      >
        ...
        <div>
          ...
          <div className="relative mt-3">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 rounded-xl bg-ink-50 border border-ink-200 text-xs focus:ring-2 focus:ring-lily-500/20"
            />
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto my-3 divide-y divide-ink-50 pr-1">
          {filtered.map((chap) => (
            ...
            >
              ...
              {chap.isCurrent && (
                <span className="text-[10px] text-lily-700 font-bold px-1.5 py-0.2 rounded bg-lily-100 shrink-0 ml-1">
                  Đang đọc
                </span>
              )}
            </div>
        ...
        <div className="pt-3 border-t border-ink-100 flex items-center justify-between text-xs text-ink-500">
          ...
          <button
            ...
            className="text-lily-700 font-medium hover:underline"
          >
            Về chương hiện tại
          </button>
        </div>

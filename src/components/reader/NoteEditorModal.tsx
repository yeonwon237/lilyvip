...
export const NoteEditorModal: React.FC<NoteEditorModalProps> = ({
  ...
  return (
    ...
    >
      <div 
        className="reader-panel w-full max-w-lg rounded-t-3xl sm:rounded-3xl shadow-modal border border-ink-100/80 overflow-hidden animate-in slide-in-from-bottom-5 sm:zoom-in-95 duration-200 max-h-[90dvh] overflow-y-auto safe-area-pb"

...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] text-ink-900">
      ...
      <footer className="border-t border-ink-200 px-5 py-7 text-xs text-ink-500 sm:px-8"><div className="mx-auto flex max-w-6xl flex-col justify-between gap-4 sm:flex-row sm:items-center"><p><strong className="font-serif text-ink-900">vip.lilyhub.top</strong> · Một sản phẩm của LilyHub</p><div className="flex flex-wrap gap-4"><button type="button" onClick={() => navigateTo('legal')}>Pháp lý & quyền riêng tư</button><a href="https://t.me/noooo4518" target="_blank" rel="noreferrer">Hỗ trợ</a><span>© 2026 LilyHub VIP</span></div></div></footer>
    </div>
  );
};
